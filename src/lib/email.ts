...
<body>
  <div class="wrapper">
    ...
    <div class="footer">
      &copy; ${new Date().getFullYear()} Corpus-Based System &bull; This is an automated message, please do not reply.
    </div>
  </div>
</body>
</html>
...
export async function sendVerificationEmail(to: string, name: string, token: string): Promise<void> {
  ...
  await transporter.sendMail({
    from: FROM,
    to,
    subject: 'Verify your Corpus-Based System Account',
    html: baseTemplate('Verify your email', `
      <p>Hi ${firstName},</p>
      <p>Welcome to the Corpus-Based System! Please verify your email address to activate your account.</p>
...
export async function sendPasswordResetEmail(to: string, name: string, token: string): Promise<void> {
  ...
  await transporter.sendMail({
    from: FROM,
    to,
    subject: 'Reset your Corpus-Based System password',
...
export async function sendPasswordChangeCode(to: string, name: string, code: string): Promise<void> {
  ...
  await transporter.sendMail({
    from: FROM,
    to,
    subject: 'Your Corpus-Based System password change code',
    html: baseTemplate('Password Change Verification', `
      <p>Hi ${firstName},</p>
      <p>You requested to change your Corpus-Based System account password. Use the code below to confirm this action.</p>
...
export async function sendWelcomeEmail(to: string, name: string): Promise<void> {
  ...
  await transporter.sendMail({
    from: FROM,
    to,
    subject: 'Welcome to the Corpus-Based System!',
    html: baseTemplate('Welcome to the Corpus-Based System', `
      <p>Hi ${firstName},</p>
      <p>Your email has been verified and your Corpus-Based System account is now active. You're ready to start training!</p>
      <a href="${BASE_URL}/auth/login" class="btn">Go to Dashboard</a>
      <hr class="divider" />
      <p class="small">The Corpus-Based System helps pilots and ATC officers improve aviation English communication through corpus-based exercises and real-world scenarios.</p>
    `),
  })
}
